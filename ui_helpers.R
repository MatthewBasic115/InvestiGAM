...
buildByConditionalInputUI <- function(ids){
  selectInput(id, label="Select Variable", multiple=FALSE)
}
...
generateBuildNavsetCardList <- function(){
  navset_card_tab(
    ...
    nav_panel("Parametric",
              ...
              actionButton("build_add_parametric_button","Add Parametric Term"),
    ...
    nav_panel("Raw Forumla",
              textInput("formula", "Raw Text Formula", "Enter Raw Formula"),      
    )
  )
}

# This function generates the navigation UI for the Interpret tab
generateInterpretNavList <- function(){
  navlistPanel(
    id="Compare",
    widths=c(2,10),
    ########### INTRO PANEL #################
      ...
      accordion(
        ...
        accordion_panel(
          ...
          layout_column_wrap(
            ...
            actionButton("plot_pred_cond_add","Generate Plot"),
          ),
      ...
      accordion(
        ...
        accordion_panel(
          ...
          layout_column_wrap(
            ...
            actionButton("comp_opt_help_button", "Comparisons Help")
          ),
          card(
            ...
            layout_column_wrap(
              ...
              actionButton("comp_dg_button", "Add Grid"),
            ),
            textOutput("comp_text"),
            actionButton("comp_dg_clear", "Clear Datagrid")
          ),
        ),
        accordion_panel(
